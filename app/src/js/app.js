...
$__System.register('13', ['12'], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ScrollingList = function (_super) {
                __extends(ScrollingList, _super);
                function ScrollingList(x, y, name) {
                    _super.call(this, x, y, name ? name : 'ScollingList');
                }
                ScrollingList.prototype.initialize = function (maxHeight, fontSize, fontColor, fontName) {
                    this._spacing = Math.floor(fontSize * 1.5);
                    this._timeLine = [];
                    this._maxHeight = maxHeight - this.y;
                    var entries = Math.floor(maxHeight / this._spacing);
                    for (var i = 0; i < entries; i++) {
                        var text = new display_1.Text(0, 0, 'emtpy', fontName, fontSize, fontColor, 'center', true, this.game.width * 0.4, -8);
                        text.centerPivot();
                        this.addChild(text);
                        text.kill();
                    }
                };
                ScrollingList.prototype.showNextName = function (name) {
                    var text = this.getFirstDead();
                    if (text === null) {
                ...
                ScrollingList.prototype._shiftDown = function (child) {
                ...
                ScrollingList.prototype.killLastChild = function (andCreate) {
                    var _this = this;
                    ...
                    var old = this._timeLine.shift();
                    this.game.add.tween(old).to({ alpha: 0 }, 300, Phaser.Easing.Cubic.In, true).onComplete.add(function () {
                        old.kill();
                        if (andCreate) {
                            _this.showNextName(andCreate);
                        }
                    });
                };
                return ScrollingList;
            }(display_1.Group);
            exports_1("default", ScrollingList);
        }
    };
});
$__System.register('14', ['9', '5', '12', '10', '11', '13'], function (exports_1, context_1) {
    "use strict";
    ...
    var BaseState_1, Constants_1, display_1, MenuMediator_1, RHButton_1, ScrollingList_1;
    var Menu;
    return {
        setters: [function (BaseState_1_1) {
            BaseState_1 = BaseState_1_1;
        ...
        }, function (ScrollingList_1_1) {
            ScrollingList_1 = ScrollingList_1_1;
        }],
        execute: function () {
            Menu = function (_super) {
                ...
                Menu.prototype._addVisuals = function () {
                    this._title = this.game.add.dText(this.realWidth * 0.725, this.realHeight * 0.1, 'GENERATOR', Constants_1.default.FONT_RALEWAY, this._fontSize, Constants_1.default.STR_BLUE);
                    this._title.centerPivot();
                    var pastNames = this.game.add.dText(this.realWidth * 0.25, this.realHeight * 0.1, "PAST NAMES", Constants_1.default.FONT_RALEWAY, this._fontSize, Constants_1.default.STR_ORANGE);
                    pastNames.centerPivot();
                    this._scrollingList = new ScrollingList_1.default(pastNames.x, pastNames.y + this._fontSize);
                    this._scrollingList.initialize(this.realHeight - 60, this._fontSize * 0.8, Constants_1.default.STR_ORANGE, Constants_1.default.FONT_RALEWAY);
                };
                Menu.prototype._addButtons = function () {
                    this._buttons = [];
                    var xPos = this.realWidth * 0.725;
                    var button = this._createButton(xPos, this.realHeight * 0.25, this._generateShipName, "RANDOM SHIP NAME");
                    this.add.existing(button);
                    var button2 = this._createButton(xPos, this.realHeight * 0.4, this._getPresetName, "PRESET SHIP NAME");
                    this.add.existing(button2);
                    var button3 = this._createButton(xPos, this.realHeight * 0.55, this._generatePlayerName, "RANDOM NAME");
                    this.add.existing(button3);
                    var button4 = this._createButton(xPos, this.realHeight * 0.7, this._generateNewInsult, "RANDOM INSULT");
                ...
                Menu.prototype._createButton = function (x, y, callback, text) {
                    var button = new RHButton_1.default(x, y, callback, this, 'ui', 'button');
                    button.centerPivot();
                    button.addLabel(text, Constants_1.default.STR_BTN_NORMAL, Constants_1.default.STR_BTN_HOVER);
...
$__System.register('15', ['16'], function (exports_1, context_1) {
    "use strict";
...
$__System.register("17", ["e"], function (exports_1, context_1) {
    "use strict";
...
$__System.register('18', ['3'], function (exports_1, context_1) {
    "use strict";
 ...
 * Wraps Phaser.Loader
*/
$__System.register('19', ['e', '3', '12'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('1a', ['e'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('1b', ['e', 'c', '3'], function (exports_1, context_1) {
    "use strict";
 ...
 * GameObjectFactory
 */
$__System.register('1c', ['12'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('20', ['e'], function (exports_1, context_1) {
    "use strict";
                ...
                */
                TransitionManager.prototype.to = function (state, args) {
                    ...
                    if (!this._transition) {
                        ...
                        this.game.changeState(this._toState, args);
                    }
                    this.transitionIn();
                };
...
$__System.register('c', ['18', '19', '1a', '1b', '1c', '1d', '1e', '1f', '20'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('24', ['e', '25', '12'], function (exports_1, context_1) {
    "use strict";
...
$__System.register("2a", ["2b"], function (exports_1, context_1) {
    "use strict";
...
$__System.register('2d', ['2c'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('2f', ['e'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('30', ['e', '3'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('12', ['28', '29', '2c', '2a', '2d', '2e', '2f', '2b', '30'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('31', ['e', '12', '3'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('3', ['21', '22', '23', '24', '25', '26', '27', '31'], function (exports_1, context_1) {
    "use strict";
...
$__System.register('32', ['d', 'c', '3'], function (exports_1, context_1) {
    "use strict";
...
$__System.register("e", ["32"], function (exports_1, context_1) {
    "use strict";
...
$__System.register('d', ['15', '17', '16', '33'], function (exports_1, context_1) {
    "use strict";
...
$__System.register("f", ["d"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            (function (ENameType) {
                ENameType[ENameType["FirstAdjective"] = 0] = "FirstAdjective";
                ENameType[ENameType["Standard"] = 1] = "Standard";
                ENameType[ENameType["TitleStandard"] = 2] = "TitleStandard";
                ENameType[ENameType["Max"] = 3] = "Max";
            })(ENameType || (ENameType = {}));
...
$__System.register("34", ["e", "c", "3", "d", "2", "5", "8", "b", "14", "f"], function (exports_1, context_1) {
    "use strict";
...
$__System.register("1", ["34"], function (exports_1, context_1) {
    "use strict";
